...
<img src="https://raw.githubusercontent.com/riebel/pixi-tiledmap/master/assets/logo.svg" width="96" height="96" alt="" />
...
![runtime dependencies][deps-image]
[![TypeScript types][types-image]][npm-url]
...
- **[Map viewer](https://pixi-tiledmap-viewer.vercel.app/)** - a curated catalog of `.tmx` maps behind a searchable picker, with a pan/zoom camera, the layer tree, a tile grid overlay, a hovered-tile inspector, and an FPS counter. You can also **upload your own `.tmx` or `.tmj` map** and share it with a generated link.
...
[npm-image]: https://img.shields.io/npm/v/pixi-tiledmap.svg
[ci-url]: https://github.com/riebel/pixi-tiledmap/actions/workflows/ci.yml
[ci-image]: https://img.shields.io/github/actions/workflow/status/riebel/pixi-tiledmap/ci.yml?branch=master&label=CI
[downloads-image]: https://img.shields.io/npm/dm/pixi-tiledmap.svg
[deps-image]: https://img.shields.io/badge/runtime%20deps-0-44cc11
[types-image]: https://img.shields.io/npm/types/pixi-tiledmap.svg
[license-url]: LICENSE.md
[license-image]: https://img.shields.io/npm/l/pixi-tiledmap.svg
[biome-url]: https://biomejs.dev
[biome-image]: https://img.shields.io/badge/checked_with-biome-60a5fa?logo=biome&logoColor=white
